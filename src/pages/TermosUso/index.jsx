  ...
  return (
    <main className="flex-fill">
      <div className="container">
        ...
        <hr />
        <p>
          Termos de Uso A passagem do Lorem Ipsum usada desde 1500 "Lorem ipsum
          ...
          mollit anim id est laborum." Secção 1.10.32 do "de Finibus Bonorum et
          Malorum", escrito por Cícero em 45 AC.
        </p>
        <p>
          ...
          qui dolorem eum fugiat quo voluptas nulla pariatur?" Tradução de 1914
          por H. Rackham "But I must explain to you how all this mistaken idea
        ...
        <p>
          ...
          no resultant pleasure?" Secção 1.10.33 do "de Finibus Bonorum et
          Malorum", escrito por Cícero em 45 AC. "At vero eos et accusamus et
        ...
        <p>
          Tradução de 1914 por H. Rackham "On the other hand, we denounce with
